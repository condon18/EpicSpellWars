...
public abstract class Card
{
    ...
    protected Card(int myID, int myInit, int myPlace, int myImage, SCHOOL mySchool) //basic constructor
    {
        idNum = myID;
        initiative = myInit;
        placement = myPlace;
    ...
    public abstract void resolve(GameStateActual currentState, int[] spell, int myCasterNum); //abstract method to be built in each CardActual
}
